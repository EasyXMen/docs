...
图5‑1UdpNmGlobalConfig容器配置图

表5‑1UdpNmGlobalConfig属性描述
...
|            |          | upport设置为FALSE。 |          |            |
+------------+----------+---------------------+----------+------------+
| UdpNmDevE  | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| rrorDetect |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 启用或者禁用DET报错 |          |            |
+------------+----------+---------------------+----------+------------+
...
|            | 依赖关系 | 无                  |          |            |
+------------+----------+---------------------+----------+------------+
| UdpNmGloba | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| lPnSupport |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 用于                |          |            |
|            |          | 全局启用部分网络支  |          |            |
...
图5‑2 UdpNmChannelConfig容器配置图

表5‑2 UdpNmChannelConfig属性描述
...
图5-5 UdpNmUserDataTxPdu容器配置图

表5‑5 UdpNmUserDataTxPdu属性描述
...
图5-6 UdpNmPnInfo容器配置图

表5‑6 UdpNmPnInfo属性描述
...
图5-7 UdpNmPnFilterMaskByte容器配置图

表5‑7 UdpNmPnFilterMaskByte属性描述
...
.. |image12| image:: ../../_static/参考手册/UdpNm/image12.png
   :width: 4.0443in
   :height: 0.78471in
.. |image13| image:: ../../_static/参考手册/UdpNm/image13.png
   :width: 4.52744in
   :height: 0.90208in
