...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertif         | 取值范围 | 1 .. 255        | 默     | 无       |
| icateChainMaxDepth |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 证书链中定      |        |          |
|                    |          | 义的最大证书数  |        |          |
+--------------------+----------+-----------------+--------+----------+
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertifi        | 取值范围 | True、False     | 默     | False    |
| cateManagerEnabled |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
|                    |          | 管理证书的部分  |        |          |
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyHan   | 取值范围 | True、False     | 默     | False    |
| dlerPrepareEnabled |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
|                    |          | 键处理          |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCrypt          | 取值范围 | True、False     | 默     | False    |
| oKeyHandlerService |          |                 | 认取值 |          |
| CertificateEnabled |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyM               | 取值范围 | True、False     | 默     | False    |
| CryptoKeyHandlerSt |          |                 | 认取值 |          |
| artFinalizeEnabled |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyHa    | 取值范围 | True、False     | 默     | False    |
| ndlerUpdateEnabled |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
|                    |          | 对密钥处        |        |          |
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyPrep  | 取值范围 | True、False     | 默     | False    |
| areFunctionEnabled |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
|                    |          | 密钥管理        |        |          |
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMC              | 取值范围 | True、False     | 默     | False    |
| ryptoKeyStartFinal |          |                 | 认取值 |          |
| izeFunctionEnabled |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCrypto         | 取值范围 | True、False     | 默     | False    |
| KeyVerifyAsyncMode |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 此参数定义函数  |        |          |
|                    |          | KeyM_Verify()   |        |          |
|                    |          | 是              |        |          |
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyVer   | 取值范围 | True、False     | 默     | False    |
| ifyFunctionEnabled |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
|                    |          | 密钥管理        |        |          |
...
|                    |          | erEnabled为TRUE |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMDevErrorDetect | 取值范围 | True、False     | 默     | False    |
|                    |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 开              |        |          |
|                    |          | 发错误检测使能  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMKe             | 取值范围 | 1 .. 255        | 默     | 无       |
| yCertNameMaxLength |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 用于服务接口    |        |          |
|                    |          | 的证书或密钥名  |        |          |
|                    |          | 称的最大长度（  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| K                  | 取值范围 | True、False     | 默     | False    |
| eyMServiceCertific |          |                 | 认取值 |          |
| ateFunctionEnabled |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 启用 (TRUE)     |        |          |
|                    |          | 或禁用 (FALSE)  |        |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| Key                | 取值范围 | Enumeration     | 默     | 无       |
| MCertAlgorithmType |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定            |        |          |
|                    |          | 提供证书的格式  |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertFormatType | 取值范围 | Enumeration     | 默     | 无       |
|                    |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定            |        |          |
|                    |          | 提供证书的格式  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertificateId  | 取值范围 | 0 .. 65535      | 默     | 无       |
|                    |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 证书的标识符。  |        |          |
|                    |          | 配置的标        |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCe             | 取值范围 | 1 .. 65535      | 默     | 无       |
| rtificateMaxLength |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定证          |        |          |
|                    |          | 书的最大长度（  |        |          |
|                    |          | 以字节为单位）  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyM               | 取值范围 | Enumeration     | 默     | 无       |
| CertificateStorage |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定            |        |          |
|                    |          | 证书的存储位置  |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCerti          | 取值范围 | Function        | 默     | 无       |
| ficateVerifyCallba |          |                 | 认取值 |          |
| ckNotificationFunc |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 此参数提供回调  |        |          |
|                    |          | <KeyM_Certific  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMServic         | 取值范围 | Function        | 默     | 无       |
| eCertificateCallba |          |                 | 认取值 |          |
| ckNotificationFunc |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 此参数          |        |          |
|                    |          | 为服务证书回调  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertCertifi    | 取值范围 | Reference       | 默     | 无       |
| cateElementRuleRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 参考应在认证    |        |          |
|                    |          | 验证步骤中验证  |        |          |
|                    |          | 的证书元素规则  |        |          |
...
|                    |          | cateElementRule |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertCsmSig     | 取值范围 | reference       | 默     | 无       |
| natureVerifyJobRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 引用            |        |          |
|                    |          | 用于验证签名的  |        |          |
|                    |          | CSM Job         |        |          |
...
|                    | 依赖关系 | CsmJob          |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertCsmSig     | 取值范围 |                 | 默     | 无       |
| natureVerifyKeyRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 对与 CSM        |        |          |
|                    |          | 签              |        |          |
|                    |          | 名验证Job关联的 |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertific       | 取值范围 | reference       | 默     | 无       |
| ateCsmKeyTargetRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定义            |        |          |
|                    |          | 对应生成的关联  |        |          |
|                    |          | CSM 密钥的引用  |        |          |
...
|                    | 依赖关系 | CsmKey          |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCert           | 取值范围 | Reference       | 默     | 无       |
| ificateNvmBlockRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定义            |        |          |
|                    |          | 对将存储证书的  |        |          |
|                    |          | NvMblock        |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| K                  | 取值范围 | Reference       | 默     | 无       |
| eyMCertPrivateKeyS |          |                 | 认取值 |          |
| torageCryptoKeyRef |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定义证书        |        |          |
|                    |          | 私钥的存储位置  |        |          |
...
|                    |          | ronizedTimeBase |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertUpperH     | 取值范围 | Reference       | 默     | 无       |
| ierarchicalCertRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | PKI             |        |          |
|                    |          | 层次结构        |        |          |
|                    |          | 中下一个更高的  |        |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertificateE   | 取值范围 | True、False     | 默     | False    |
| lementHasIteration |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定              |        |          |
|                    |          | 义证书元素是否  |        |          |
|                    |          | 可以出现多次。  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCe             | 取值范围 | 0 .. 65535      | 默     | 无       |
| rtificateElementId |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 证              |        |          |
|                    |          | 书元素的标识符  |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertifica      | 取值范围 | 1 .. 65535      | 默     | 无       |
| teElementMaxLength |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 证书的标识符。  |        |          |
|                    |          | 配置的标        |        |          |
|                    |          | 识符集应该是连  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertific       | 取值范围 | 无              | 默     | 无       |
| ateElementObjectId |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 这是            |        |          |
|                    |          | 用于标识其元素  |        |          |
|                    |          | 结构中的证书元  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertificat     | 取值范围 | 无              | 默     | 无       |
| eElementObjectType |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 证书元素以      |        |          |
|                    |          | ASN.1           |        |          |
|                    |          | 格式存储。      |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertificate    | 取值范围 | Enumeration     | 默     | 无       |
| ElementOfStructure |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 这              |        |          |
|                    |          | 定义了证书元素  |        |          |
|                    |          | 位于哪个结构中  |        |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| K                  | 取值范围 | Enumeration     | 默     | 无       |
| eyMLogicalOperator |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 此              |        |          |
|                    |          | 参数指定要在逻  |        |          |
|                    |          | 辑表达式中使用  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMArgumentRef    | 取值范围 | reference       | 默     | 无       |
|                    |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 这是            |        |          |
|                    |          | 对条件或另一个  |        |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertEl         | 取值范围 | Enumeration     | 默     | 无       |
| ementConditionType |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 此参数指定为    |        |          |
|                    |          | 评估模式条件而  |        |          |
|                    |          | 进行的比较类型  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCer            | 取值范围 | reference       | 默     | 无       |
| tificateElementRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 对用于条件的    |        |          |
|                    |          | 证书元素的引用  |        |          |
+--------------------+----------+-----------------+--------+----------+
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCertific       | 取值范围 | 0 .. 65535      | 默     | 无       |
| ateElementConditio |          |                 | 认取值 |          |
| nArrayElementIndex |          |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 比较值          |        |          |
|                    |          | 数组元素的索引  |        |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCerti          | 取值范围 | 0 ..            | 默     | 无       |
| ficateElementCondi |          |                 | 认取值 |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryp           | 取值范围 | Enumeration     | 默     | 无       |
| toCsmVerifyJobType |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定使          |        |          |
|                    |          | 用哪种类型的密  |        |          |
|                    |          | 钥验证操作函数  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCr             | 取值范围 | String          | 默     | 无       |
| yptoKeyCryptoProps |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 如              |        |          |
|                    |          | 果设置，它将为  |        |          |
|                    |          | KeyM            |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCrypt          | 取值范围 | String          | 默     | 无       |
| oKeyGenerationInfo |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 该数据可能      |        |          |
|                    |          | 包含用于密钥派  |        |          |
|                    |          | 生的静态数据。  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCrypt          | 取值范围 | Enumeration     | 默     | 无       |
| oKeyGenerationType |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定如何生成    |        |          |
|                    |          | CryptoKey。     |        |          |
|                    |          | 如果它是从      |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyId    | 取值范围 | 0 .. 65535      | 默     | 无       |
|                    |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 加密            |        |          |
|                    |          | 密钥的标识符。  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyM               | 取值范围 | 1 .. 4294967295 | 默     | 无       |
| CryptoKeyMaxLength |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | CryptoKey       |        |          |
|                    |          | 的最大字节数    |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyName  | 取值范围 | String          | 默     | 无       |
|                    |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 提供密钥的唯一  |        |          |
|                    |          | 名称以供识别。  |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| Ke                 | 取值范围 | Enumeration     | 默     | 无       |
| yMCryptoKeyStorage |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 指定            |        |          |
|                    |          | 证书的存储位置  |        |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCryptoKeyCsm   | 取值范围 | reference       | 默     | 无       |
| KeySourceDeriveRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定义对          |        |          |
|                    |          | 用作此密钥的密  |        |          |
|                    |          | 钥派生源的关联  |        |          |
...
|                    | 依赖关系 | CsmKey          |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCrypto         | 取值范围 | reference       | 默     | 无       |
| KeyCsmKeyTargetRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定义            |        |          |
|                    |          | 对应生成的关联  |        |          |
|                    |          | CSM 密钥的引用  |        |          |
...
|                    | 依赖关系 | CsmJob          |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMCr             | 取值范围 | Reference       | 默     | 无       |
| yptoKeyNvmBlockRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 定义            |        |          |
|                    |          | 对将存储密钥的  |        |          |
|                    |          | NvM 块的引用    |        |          |
...
| **UI名称**         | **描述** |                 |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMNv             | 取值范围 | 0 .. 65535      | 默     | 无       |
| mBlockWriteDelayed |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 这是更          |        |          |
|                    |          | 新后将密钥写入  |        |          |
|                    |          | NVM             |        |          |
...
|                    | 依赖关系 | 无              |        |          |
+--------------------+----------+-----------------+--------+----------+
| KeyMNvm            | 取值范围 | reference       | 默     | 无       |
| BlockDescriptorRef |          |                 | 认取值 |          |
+--------------------+----------+-----------------+--------+----------+
|                    | 参数描述 | 引              |        |          |
|                    |          | 用到Nvm的Block  |        |          |
+--------------------+----------+-----------------+--------+----------+
...
.. |image9| image:: ../../_static/参考手册/KeyM/image9.png
   :width: 5.58333in
   :height: 1.34375in
.. |image10| image:: ../../_static/参考手册/KeyM/image10.png
   :width: 5.76736in
   :height: 4.10833in
.. |image11| image:: ../../_static/参考手册/KeyM/image11.png
   :width: 5.75in
   :height: 1.60417in
