...
Seed&Key功能功能由GET_SEED和UNLOCK命令实现。
...
图5-1 Bus Interface Select配置图

表5-1 Bus Interface Select属性描述
...
图5-4 General Settings配置图

表5-4 General Settings属性描述
...
|            |          | NO_TIMESTAMP        |          |            |
+------------+----------+---------------------+----------+------------+
| XcpTim     | 取值范围 | NO_TIME_STAMP       | 默认取值 | NO_        |
| estampType |          |                     |          | TIME_STAMP |
|            |          | ONE_BYTE            |          |            |
|            |          |                     |          |            |
|            |          | TWO_BYTE            |          |            |
|            |          |                     |          |            |
...
|            | 依赖关系 | 无                  |          |            |
+------------+----------+---------------------+----------+------------+
| XcpTim     | 取值范围 | 1 us – 100ms        | 默认取值 | TIMESTAMP_ |
| estampUnit |          |                     |          | UNIT_100MS |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | Timest              |          |            |
|            |          | amp单位时间长度单位 |          |            |
+------------+----------+---------------------+----------+------------+
...
图5-5 General Command配置图

表5-5 General Command属性描述
...
|            |          | 置为XcpOnCanEnabled |          |            |
+------------+----------+---------------------+----------+------------+
| Slave_     | 取值范围 | TRUE/FALSE          | 默认取值 | TRUE       |
| Block_Mode |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
...
|            | 依赖关系 | 无                  |          |            |
+------------+----------+---------------------+----------+------------+
| Master_    | 取值范围 | TRUE/FALSE          | 默认取值 | TRUE       |
| Block_Mode |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 使能Master          |          |            |
|            |          | Block模式           |          |            |
...
|            |          | _ENABLE打开的情况下 |          |            |
+------------+----------+---------------------+----------+------------+
| GET_DAQ_   | 取值范围 | TRUE/FALSE          | 默认取值 | FALSE      |
| EVENT_INFO |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 使能支持GET         |          |            |
|            |          | _DAQ_EVENT_INFO命令 |          |            |
...
图5-13 XcpOdtEntry配置图

表5-13 XcpOdtEntry属性描述
...
图5-14 XcpEventChannel配置图

表5-14 XcpEventChannel属性描述
...
|            | 依赖关系 | 无                  |          |            |
+------------+----------+---------------------+----------+------------+
| Xcp        | 取值范围 | XCP_TIME_UNIT_1NS   | 默认取值 | TIMESTAMP_ |
| EventChann |          |                     |          | UNIT_100MS |
...
.. |image1| image:: ../../_static/参考手册/XCP/image1.png
   :width: 3.04722in
   :height: 2.68889in
.. |daq.jpg| image:: ../../_static/参考手册/XCP/image2.png
   :width: 4.85278in
   :height: 2.58125in
...
.. |image9| image:: ../../_static/参考手册/XCP/image11.png
   :width: 5.21875in
   :height: 0.625in
.. |image10| image:: ../../_static/参考手册/XCP/image12.png
   :width: 5.76736in
   :height: 0.93681in
...
.. |image12| image:: ../../_static/参考手册/XCP/image14.png
   :width: 5.76736in
   :height: 0.55694in
.. |image13| image:: ../../_static/参考手册/XCP/image15.png
   :width: 5.76736in
   :height: 0.77569in
.. |image14| image:: ../../_static/参考手册/XCP/image16.png
   :width: 5.21875in
   :height: 0.84375in
.. |image15| image:: ../../_static/参考手册/XCP/image17.png
   :width: 5.1875in
   :height: 1.02083in
.. |image16| image:: ../../_static/参考手册/XCP/image18.png
   :width: 4.82947in
   :height: 0.84921in
.. |image17| image:: ../../_static/参考手册/XCP/image19.png
   :width: 4.16667in
   :height: 0.98958in
.. |image18| image:: ../../_static/参考手册/XCP/image20.png
   :width: 4.40625in
   :height: 0.65625in
