...
+----------------+-----------------------------------------------------+
| Rte_Dlt_Type.h | Dlt模块与RTE模块交互的类型定义头文件                |
+----------------+-----------------------------------------------------+
...
Dlt模块的文件结构如图所示。Dlt功能模块由10个文件组成，其中Dlt.c，Dlt.h两个文件中实现了Dlt的主要功能
，这两个文件是每个Dlt模块必须实现的。
...
|           | {                                                        |
|           |                                                          |
|           | Dlt_MessageTypeType message_type;                        |
|           |                                                          |
|           | Dlt_SessionIDType session_id;                            |
|           |                                                          |
|           | Dlt_MessageLogInfoType log_info;                         |
|           |                                                          |
|           | Dlt_MessageTraceInfoType trace_info;                     |
|           |                                                          |
|           | } Dlt_FilterInfoType;                                    |
+-----------+----------------------------------------------------------+
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的过滤信息的结构体类型                    |
+-----------+----------------------------------------------------------+
...
|           | {                                                        |
|           |                                                          |
|           | uint8 UseExtendedHeader : 1;                             |
|           |                                                          |
|           | uint8 MostSignificantByteFirst : 1;                      |
|           |                                                          |
|           | uint8 WithEcuId : 1;                                     |
|           |                                                          |
|           | uint8 WithSessionId : 1;                                 |
|           |                                                          |
|           | uint8 WithTimestamp : 1;                                 |
|           |                                                          |
...
|           | {                                                        |
|           |                                                          |
|           | uint32 Type_Length : 4;                                  |
|           |                                                          |
|           | uint32 Type_Bool : 1;                                    |
|           |                                                          |
|           | uint32 Type_Signed : 1;                                  |
|           |                                                          |
|           | uint32 Type_Unsigned : 1;                                |
|           |                                                          |
|           | uint32 Type_Float : 1;                                   |
|           |                                                          |
|           | uint32 Type_Array : 1;                                   |
...
|           | uint32 Type_Raw : 1;                                     |
|           |                                                          |
|           | uint32 Variable_Info : 1;                                |
|           |                                                          |
|           | uint32 Fixed_Point : 1;                                  |
|           |                                                          |
|           | uint32 Trace_Info : 1;                                   |
|           |                                                          |
|           | uint32 Type_Struct : 1;                                  |
|           |                                                          |
|           | uint32 String_Coding : 3;                                |
|           |                                                          |
|           | uint32 Reserved : 14;                                    |
|           |                                                          |
|           | } Dlt_Bits;                                              |
...
|           | {                                                        |
|           |                                                          |
|           | Dlt_DataTypeInfoType Type_Info;                          |
|           |                                                          |
|           | const uint8 \*Data_Payload;                              |
|           |                                                          |
|           | } Dlt_MessageFormatType;                                 |
+-----------+----------------------------------------------------------+
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的消息格式的结构体类型                    |
+-----------+----------------------------------------------------------+
...
|           | {                                                        |
|           |                                                          |
|           | Dlt_MessageInfoType MessageInfo;                         |
|           |                                                          |
|           | uint8 NumberOfArguments;                                 |
|           |                                                          |
|           | Dlt_ApplicationIDType ApplicationId;                     |
|           |                                                          |
...
+-----------+----------------------------------------------------------+
| 名称      | Dlt_NonVerboseLogMessageType                             |
+-----------+----------------------------------------------------------+
| 类型      | structure                                                |
+-----------+----------------------------------------------------------+
| 定义      | typedef struct                                           |
...
|           | {                                                        |
|           |                                                          |
|           | Dlt_StandardHeaderType Standard_Header;                  |
|           |                                                          |
|           | Dlt_ExtendedHeaderType Extended_Header;                  |
|           |                                                          |
|           | Dlt_MessageIDType Message_Id;                            |
|           |                                                          |
|           | const uint8 \*logData;                                   |
|           |                                                          |
...
|           | Dlt_ExtendedHeaderType Extended_Header;                  |
|           |                                                          |
|           | Dlt_MessageFormatType Log_Data[10];                      |
|           |                                                          |
|           | } Dlt_VerboseLogMessageType;                             |
+-----------+----------------------------------------------------------+
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的冗余模式日志消息的结构体类型            |
+-----------+----------------------------------------------------------+
...
+-----------+----------------------------------------------------------+
| 名称      | Dlt_NonVerboseTraceMessageType                           |
+-----------+----------------------------------------------------------+
| 类型      | structure                                                |
+-----------+----------------------------------------------------------+
| 定义      | typedef struct                                           |
...
+-----------+----------------------------------------------------------+
| 名称      | Dlt_VerboseTraceMessageType                              |
+-----------+----------------------------------------------------------+
| 类型      | structure                                                |
+-----------+----------------------------------------------------------+
| 定义      | typedef struct                                           |
...
|           | Dlt_ExtendedHeaderType Extended_Header;                  |
|           |                                                          |
|           | Dlt_MessageFormatType Trace_Data[10];                    |
|           |                                                          |
|           | } Dlt_VerboseTraceMessageType;                           |
+-----------+----------------------------------------------------------+
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的冗余模式跟踪消息的结构体类型            |
+-----------+----------------------------------------------------------+
...
+-----------+----------------------------------------------------------+
| 名称      | Dlt_NonVerboseDetLogMsgType                              |
+-----------+----------------------------------------------------------+
| 类型      | structure                                                |
+-----------+----------------------------------------------------------+
| 定义      | typedef struct                                           |
...
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的非冗余模式Det日志消息的结构体类型       |
+-----------+----------------------------------------------------------+
...
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的冗余模式Det日志消息的结构体类型         |
+-----------+----------------------------------------------------------+
...
|           |                                                          |
|           | Dlt_LogLevelType LogChannelThreshold;                    |
|           |                                                          |
|           | uint16 ApplicationIdCount;                               |
|           |                                                          |
|           | Dlt_ApplicationIdInfoType ApplicationIdInfo[5];          |
|           |                                                          |
|           | } Dlt_LogChannelInfoType;                                |
+-----------+----------------------------------------------------------+
| 范围      | 无                                                       |
+-----------+----------------------------------------------------------+
| 描述      | 用于定义Dlt模块的日志通道信息的结构体类型                |
+-----------+----------------------------------------------------------+
...
|         | );                                                         |
+---------+------------------------------------------------------------+
| NvM     | Std_ReturnType NvM_ReadBlock                               |
|         |                                                            |
|         | (                                                          |
|         |                                                            |
...
|             |                                  | 域： | -4294967295 |
+-------------+----------------------------------+------+-------------+
|             | traceInfo：跟踪信息参数          | 值   | 无          |
|             |                                  | 域： |             |
+-------------+----------------------------------+------+-------------+
|             | traceData：跟踪数据缓冲区        | 值   | 无          |
|             |                                  | 域： |             |
+-------------+----------------------------------+------+-------------+
...
| 输出参数：  |                                  |      |             |
+-------------+----------------------------------+------+-------------+
| 输出参数：  | status：运行时执行状态           | 值   | 无          |
|             |                                  | 域： |             |
+-------------+----------------------------------+------+-------------+
|             | logInfo：返回当前日志信息        | 值   | 无          |
|             |                                  | 域： |             |
+-------------+----------------------------------+------+-------------+
| 返回值：    | Std_ReturnType：                 |      |             |
|             |                                  |      |             |
...
+-------------+----------------------------------+------+-------------+
| 输出参数：  | nu                               | 值   | 无          |
|             | mberOfLogChannel：日志通道的数量 | 域： |             |
+-------------+----------------------------------+------+-------------+
|             | logChannelName：日志通道名称     | 值   | 无          |
|             |                                  | 域： |             |
+-------------+----------------------------------+------+-------------+
| 返回值：    | Std_ReturnType：                 |      |             |
|             |                                  |      |             |
...
| 输出参数： |                                 |     |                |
+------------+---------------------------------+-----+----------------+
| 输出参数： | newThreshold：新的日志通道阈值  | 值  | 无             |
|            |                                 | 域  |                |
|            |                                 | ：  |                |
+------------+---------------------------------+-----+----------------+
|            | newTraceStatus：新的跟踪状态    | 值  | 无             |
|            |                                 | 域  |                |
|            |                                 | ：  |                |
+------------+---------------------------------+-----+----------------+
| 返回值：   | Std_ReturnType：                |     |                |
...
|             | PDU 相关的元数据。                    |     |          |
+-------------+---------------------------------------+-----+----------+
|             | Result：N-PDU接收的结果               | 值  | E_OK     |
|             |                                       | 域  |          |
|             | E_OK：PDU接收成功                     | ：  | E_NOT_OK |
|             |                                       |     |          |
|             | E_NOT_OK：PDU接收失败                 |     |          |
+-------------+---------------------------------------+-----+----------+
| 输入        | 无                                    |     |          |
...
|             |                                       | 域： | -65535 |
+-------------+---------------------------------------+------+--------+
|             | PduInfoPtr：包含一个指向要复制SDU数据 | 值   | 无     |
|             | 的缓冲区(SduDataPtr)的指针，以及SduLe | 域： |        |
|             | ngh中可用的缓冲区大小。返回时，服务将 |      |        |
|             | 在SduLength中指示复制的SDU数据的长度  |      |        |
+-------------+---------------------------------------+------+--------+
| 输入        | 无                                    |      |        |
| 输出参数：  |                                       |      |        |
+-------------+---------------------------------------+------+--------+
...
|             |                                       | 域： | -65535 |
+-------------+---------------------------------------+------+--------+
|             | Info：提供目标缓冲区(SduDataPtr)和要  | 值   | 无     |
|             | 复制的字节数(SduLength)。如果没有足够 | 域： |        |
|             | 的发送数据可用，上层模块不会复制数据  |      |        |
|             | ，并返回BUFREQ_E_BUSY。下层模块可以重 |      |        |
|             | 试调用。SduLength为0可用于指示重试参  |      |        |
|             | 数中的状态变化或查询上层模块中当前可  |      |        |
|             | 用数据的数量。在本例中，SduDataPtr可  |      |        |
|             | 能 是 一 个NULL_PTR。                 |      |        |
+-------------+---------------------------------------+------+--------+
|             | Retry：此参数用于确认已发送           | 值   | 无     |
|             | 数据或在发送出现问题后重新发送数据。  | 域： |        |
+-------------+---------------------------------------+------+--------+
| 输入        | 无                                    |      |        |
| 输出参数：  |                                       |      |        |
+-------------+---------------------------------------+------+--------+
| 输出参数：  | availableDataPt                       | 值   | 无     |
|             | r：指示上层模块的Tx缓冲区中可用的剩余 | 域： |        |
|             | 字节数。availableDataPtr可被支持动态  |      |        |
|             | 负载长度的TP模块用于确定以下CF的大小  |      |        |
+-------------+---------------------------------------+------+--------+
...
+-------------+---------------------------------------+------+--------+
|             | info：一个PduIn                       | 值   | 无     |
|             | foType结构的指针，它包含传输协议I-PDU | 域： |        |
|             | 接收的首帧或单帧的有效负载数据(没有协 |      |        |
|             | 议信息)和有效负载长度，以及与这个PDU  |      |        |
|             | 相关的元数据。如果首帧/单帧数据或元数 |      |        |
|             | 据都不可用，则此参数设置为NULL_PTR。  |      |        |
+-------------+---------------------------------------+------+--------+
...
+-------------+---------------------------------------+------+--------+
|             | info：提供                            | 值   | 无     |
|             | 源缓冲区(SduDataPtr)和要复制的字节数  | 域： |        |
|             | (SduLength)。SduLength为0可以用来查询 |      |        |
|             | 上层模块中可用缓冲区的当前数量。在本  |      |        |
|             | 例中，SduDataPtr可能是一个NULL_PTR。  |      |        |
+-------------+---------------------------------------+------+--------+
| 输入        | 无                                    |      |        |
| 输出参数：  |                                       |      |        |
+-------------+---------------------------------------+------+--------+
| 输出参数：  | buff                                  | 值   | 无     |
|             | erSizePtr：数据复制后可用的接收缓冲区 | 域： |        |
+-------------+---------------------------------------+------+--------+
| 返回值：    | BufReq_ReturnType：                   |      |        |
|             |                                       |      |        |
|             | BUFREQ_OK：数据复制成功               |      |        |
...
| 名称** |           |                       |   |           |   |           |
+--------+-----------+-----------------------+---+-----------+---+-----------+
| DltGen | 取值范围  | STD_ON,STD_OFF        | 默 |          | S |           |
| eralDe |           |                       | 认 |          | T |           |
| vError |           |                       | 取 |          | D |           |
| Detect |           |                       | 值 |          | _ |           |
|        |           |                       |   |           | O |           |
...
| |image31|
| 图5-26 Dlt模块TraceStatusAssignmentSwcContext配置容器界面
...
.. |image6| image:: ../../_static/参考手册/Dlt/image6.png
   :width: 5.76736in
   :height: 4.95417in
.. |C:\\Users\\Administrator\\Desktop\\Dlt\\DltMGeneral.PNG| image:: ../../_static/参考手册/Dlt/image7.png
   :width: 5.76736in
   :height: 4.87639in
.. |image7| image:: ../../_static/参考手册/Dlt/image8.png
   :width: 5.76736in
   :height: 4.81042in
.. |image8| image:: ../../_static/参考手册/Dlt/image9.png
   :width: 5.76736in
   :height: 4.34444in
.. |image9| image:: ../../_static/参考手册/Dlt/image10.png
   :width: 5.76736in
   :height: 4.63889in
.. |image10| image:: ../../_static/参考手册/Dlt/image11.png
   :width: 5.76736in
   :height: 3.48542in
.. |image11| image:: ../../_static/参考手册/Dlt/image12.png
   :width: 5.76736in
   :height: 3.50556in
.. |image12| image:: ../../_static/参考手册/Dlt/image13.png
   :width: 5.76736in
   :height: 3.34028in
.. |image13| image:: ../../_static/参考手册/Dlt/image14.png
   :width: 5.76736in
   :height: 3.50625in
.. |image14| image:: ../../_static/参考手册/Dlt/image15.png
   :width: 5.76736in
   :height: 4.55486in
.. |image15| image:: ../../_static/参考手册/Dlt/image16.png
   :width: 5.76736in
   :height: 3.59653in
.. |image16| image:: ../../_static/参考手册/Dlt/image17.png
   :width: 5.76736in
   :height: 3.53472in
.. |image17| image:: ../../_static/参考手册/Dlt/image18.png
   :width: 5.76736in
   :height: 2.93125in
.. |image18| image:: ../../_static/参考手册/Dlt/image19.png
   :width: 5.76736in
   :height: 2.95069in
.. |image19| image:: ../../_static/参考手册/Dlt/image20.png
   :width: 5.76736in
   :height: 2.93125in
.. |image20| image:: ../../_static/参考手册/Dlt/image21.png
   :width: 5.76736in
   :height: 2.95486in
.. |image21| image:: ../../_static/参考手册/Dlt/image22.png
   :width: 5.76736in
   :height: 3.24514in
.. |image22| image:: ../../_static/参考手册/Dlt/image23.png
   :width: 5.76736in
   :height: 4.55833in
.. |image23| image:: ../../_static/参考手册/Dlt/image24.png
   :width: 5.76736in
   :height: 4.52014in
.. |image24| image:: ../../_static/参考手册/Dlt/image25.png
   :width: 5.76736in
   :height: 3.30903in
.. |image25| image:: ../../_static/参考手册/Dlt/image26.png
   :width: 5.76736in
   :height: 3.52569in
.. |image26| image:: ../../_static/参考手册/Dlt/image27.png
   :width: 5.76736in
   :height: 2.78194in
.. |image27| image:: ../../_static/参考手册/Dlt/image28.png
   :width: 5.76736in
   :height: 4.75972in
.. |image28| image:: ../../_static/参考手册/Dlt/image29.png
   :width: 5.76736in
   :height: 2.71042in
.. |image29| image:: ../../_static/参考手册/Dlt/image30.png
   :width: 5.76736in
   :height: 4.74931in
.. |image30| image:: ../../_static/参考手册/Dlt/image31.png
   :width: 5.76736in
   :height: 3.16597in
.. |image31| image:: ../../_static/参考手册/Dlt/image32.png
   :width: 5.76736in
   :height: 2.75347in
.. |image32| image:: ../../_static/参考手册/Dlt/image33.png
   :width: 5.76736in
   :height: 3.77014in
.. |image33| image:: ../../_static/参考手册/Dlt/image34.png
   :width: 5.76736in
   :height: 3.35139in
.. |image34| image:: ../../_static/参考手册/Dlt/image35.png
   :width: 5.76736in
   :height: 3.47639in
