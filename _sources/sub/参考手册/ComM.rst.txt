...
| 输出参数:  |                 |        |                             |
+------------+-----------------+--------+-----------------------------+
| 输出参数： | CounterValue    | 值域： | 被拒绝的COMM_FULL_CO        |
|            |                 |        | MMUNICATION用户请求的数量。 |
+------------+-----------------+--------+-----------------------------+
| 返回值：   | E_OK：成功      |        |                             |
|            | 返回抑制计数器  |        |                             |
...
图5-1 ComMGeneral容器配置图

表5‑1 ComMGeneral属性描述
...
图5-2 ComMConfigSet容器配置图

表5‑2 ComMConfigSet属性描述
...
图5-3 ComMChannel容器配置图

表5‑3 ComMChannel属性描述
...
图5-4 ComMNetworkManagement容器配置图

表5‑4 ComMNetworkManagement属性描述
...
图5-5 ComMUserPerChannel容器配置图

表5‑5 ComMUserPerChannel属性描述
...
图5-7 ComMPNCComSignal容器配置图

表5‑7 ComMPNCComSignal属性描述
...
.. |image5| image:: ../../_static/参考手册/ComM/image6.png
   :width: 5.76736in
   :height: 1.70694in
.. |image6| image:: ../../_static/参考手册/ComM/image7.png
   :width: 4.14167in
   :height: 3.5in
.. |image7| image:: ../../_static/参考手册/ComM/image8.png
   :width: 2.83114in
   :height: 0.52205in
.. |image8| image:: ../../_static/参考手册/ComM/image9.png
   :width: 3.2in
   :height: 1.94931in
.. |image9| image:: ../../_static/参考手册/ComM/image10.png
   :width: 3.41528in
   :height: 0.77569in
.. |image10| image:: ../../_static/参考手册/ComM/image11.png
   :width: 3.45556in
   :height: 0.46111in
.. |image11| image:: ../../_static/参考手册/ComM/image12.png
   :width: 2.83958in
   :height: 3.76736in
.. |image12| image:: ../../_static/参考手册/ComM/image13.png
   :width: 4.125in
   :height: 1in
.. |image13| image:: ../../_static/参考手册/ComM/image14.png
   :width: 3.34375in
   :height: 0.71736in
