...
+-------------------+--------------------------------------------------+
| CanNm_Cbk.h       | 包含CanNm供SoAd调用的API函数的声明               |
+-------------------+--------------------------------------------------+
...
|            |          | upport设置为FALSE。 |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmDevE  | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| rrorDetect |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 启用或者禁用DET报错 |          |            |
+------------+----------+---------------------+----------+------------+
...
|            |          | 模式。              |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmAc    | 取值范围 | STD_ON,STD_OFF      | 默认取值 | FALSE      |
| tiveWakeup |          |                     |          |            |
| BitEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 在CanNm模块中       |          |            |
...
|            |          | bled为False时可配置 |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmAl    | 取值范围 | STD_ON,STD_OFF      | 默认取值 | FALSE      |
| lNmMessage |          |                     |          |            |
| sKeepAwake |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 指定 CanNm          |          |            |
...
|            |          | == true时有效       |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmBu    | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| sLoadReduc |          |                     |          |            |
| tionActive |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 该参数定义了        |          |            |
...
|            |          | (CBV,NID)           |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmCa    | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| rWakeUpFil |          |                     |          |            |
| terEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 如果                |          |            |
...
|            |          | pFilterEnabled=TRUE |          |            |
+------------+----------+---------------------+----------+------------+
| Can        | 取值范围 | STD_ON,STD_OFF      | 默认取值 | FALSE      |
| NmCarWakeU |          |                     |          |            |
| pRxEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 启                  |          |            |
...
|            |          | mCarWakeUpRxEnabled |          |            |
+------------+----------+---------------------+----------+------------+
| CanNm      | 取值范围 | 0.001 .. 65.535     | 默认取值 | 无         |
| ImmediateN |          |                     |          |            |
| mCycleTime |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 定义用于CanNmImmed  |          |            |
...
|            |          | > 0                 |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmMsgC  | 取值范围 | 0~65.535            | 默认取值 | 无         |
| ycleOffset |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 周期性传输节        |          |            |
|            |          | 点中的时间偏移。它  |          |            |
...
|            |          | nabled为False时有效 |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmMs    | 取值范围 | 0.001~65.535        | 默认取值 | 无         |
| gCycleTime |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | NM                  |          |            |
|            |          | PDU的周             |          |            |
...
|            |          | 是传输调度的基础。  |          |            |
+------------+----------+---------------------+----------+------------+
|            | 依赖关系 | 当“CanNmPassiveM    |          |            |
|            |          | odeEnabled”为“False |          |            |
|            |          | ”时，此参数才有效。 |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmMsgR  | 取值范围 | 0.001~65.535        | 默认取值 | 无         |
| educedTime |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 减负载的周期传输    |          |            |
|            |          | 时间，以秒为单位。  |          |            |
...
|            |          | 否则不使用此参数。  |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmMsgT  | 取值范围 | 0.001~65.535        | 默认取值 | 无         |
| imeoutTime |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 当使用部分网络并    |          |            |
|            |          | 定义此超时时，CanNm |          |            |
...
|            |          | == True 时有效      |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmPduC  | 取值范围 | CANNM_PDU_BYTE_0    | 默认取值 | 无         |
| bvPosition |          |                     |          |            |
|            |          | CANNM_PDU_BYTE_1    |          |            |
|            |          |                     |          |            |
|            |          | CANNM_PDU_OFF       |          |            |
...
|            |          | ION=CANNM_PDU_BYTE0 |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmPduN  | 取值范围 | CANNM_PDU_BYTE_0    | 默认取值 | 无         |
| idPosition |          |                     |          |            |
|            |          | CANNM_PDU_BYTE_1    |          |            |
|            |          |                     |          |            |
|            |          | CANNM_PDU_OFF       |          |            |
...
|            |          | CANNM_PDU_BYTE0     |          |            |
+------------+----------+---------------------+----------+------------+
| CanN       | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| mPnEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 使能或者禁用PN      |          |            |
+------------+----------+---------------------+----------+------------+
...
|            |          | 需要配置CanNmPnInfo |          |            |
+------------+----------+---------------------+----------+------------+
| C          | 取值范围 | STD_ON,STD_OFF      | 默认取值 | FALSE      |
| anNmPnEraC |          |                     |          |            |
| alcEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 指定CanNm是否计算外 |          |            |
...
|            |          | == true 时有效      |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmP     | 取值范围 | STD_ON,STD_OFF      | 默认取值 | FALSE      |
| nHandleMul |          |                     |          |            |
| tipleNetwo |          |                     |          |            |
| rkRequests |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
...
|            |          | mmediateNmCycleTime |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmRetr  | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| yFirstMess |          |                     |          |            |
| ageRequest |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 指定 CanNm          |          |            |
...
|            |          | essageRequest=false |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmT     | 取值范围 | 0.002~65.535        | 默认取值 | 无         |
| imeoutTime |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | NM                  |          |            |
|            |          | PDU的网络超         |          |            |
...
|            |          | eadySleep状态的时间 |          |            |
+------------+----------+---------------------+----------+------------+
|            | 依赖关系 | CanNmTimeoutTime >  |          |            |
|            |          | CanNmMsgCycleTime   |          |            |
+------------+----------+---------------------+----------+------------+
| C          | 取值范围 | 0.001~65.535        | 默认取值 | 无         |
| anNmWaitBu |          |                     |          |            |
| sSleepTime |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 表                  |          |            |
...
|            |          | 数应该是强制性的。  |          |            |
+------------+----------+---------------------+----------+------------+
| CanNm      | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| NodeDetect |          |                     |          |            |
| ionEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 预编译时间切换      |          |            |
...
|            |          | = False             |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmNod   | 取值范围 | STD_ON,STD_OFF      | 默认取值 | 无         |
| eIdEnabled |          |                     |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 用于启用源节点      |          |            |
|            |          | 标识的预处理器开关  |          |            |
...
|            |          | bled，否则等于False |          |            |
+------------+----------+---------------------+----------+------------+
| CanNmPnEr  | 取值范围 | Reference to [ Pdu  | 默认取值 | 无         |
| aRxNSduRef |          | ]                   |          |            |
+------------+----------+---------------------+----------+------------+
|            | 参数描述 | 参考COM堆栈中的Pdu  |          |            |
|            |          | 。每个CanNm通道都需 |          |            |
...
|            |          | 要在PDUR中进行关联  |          |            |
+------------+----------+---------------------+----------+------------+
| CanNm      | 取值范围 | Reference to [      | 默认取值 | 无         |
...
.. |image12| image:: ../../_static/参考手册/CanNm/image12.png
   :width: 3.2875in
   :height: 0.65347in
.. |image13| image:: ../../_static/参考手册/CanNm/image13.png
   :width: 4.09583in
   :height: 0.77222in
