...
|                                                    | type**          |
+====================================================+=================+
| Demo_S32K148_V2510_BSW_ConfigProject               | BSW配置工程     |
|                                                    |                 |
|                                                    | BSW             |
|                                                    | configuration   |
|                                                    | project         |
+----------------------------------------------------+-----------------+
| Demo_S32K148_V2510_S32DS_V3p5_Project              | BSW集成工程     |
|                                                    |                 |
|                                                    | BSW integration |
|                                                    | project         |
+----------------------------------------------------+-----------------+
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image1.png
   :width: 5.3307in
   :height: 3.81932in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image2.png
   :width: 5.56182in
   :height: 1.10461in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image3.png
   :width: 5.97842in
   :height: 6.41587in

CommonInclude：存放共用的头文件，比如Std_Types.h、Compiler.h、ComStack_Types.h等，此工程这些文件使用MCAL中的，不存在此文件夹。

CommonInclude: Stores shared header files such as Std_Types.h,
Compiler.h, ComStack_Types.h, etc. These files for this project are
stored in MCAL and do not exist in this folder.
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image4.png
   :width: 6.02008in
   :height: 0.89572in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image5.png
   :width: 6.02008in
   :height: 4.10365in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image6.png
   :width: 5.99925in
   :height: 0.87489in

Main：主函数入口文件。

Main: Main function entry files.

.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image7.png
   :width: 5.99925in
   :height: 0.60409in
...
On the S32K148 development board, once the ECU is powered on, it will
actively request the network. After the network is released, when the
ECU enters sleep mode, Mcu_PerformReset will be called directly to
reset.
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image8.png
   :width: 6.74167in
   :height: 7.26667in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image9.png
   :width: 6.59167in
   :height: 3.96806in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image10.png
   :width: 6.64097in
   :height: 2.79097in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image14.png
   :width: 7.03194in
   :height: 2.23819in
...
include Flash, MemAcc, FEE, and NvM modules, and the main functions of
each module are shown in the table below:
...
+--------+-------------------------------------------------------------+
| MemAcc | 提供基于地址                                                |
|        | 作为参数的接口方式，向上层提供能够访问不同存储设备的能力。  |
|        |                                                             |
|        | Provide an interface mode based on the address as a         |
|        | parameter, and provide the upper layer with the capability  |
|        | to access different storage devices.                        |
+--------+-------------------------------------------------------------+
...
+-----------------------+---------+----------+----------+------------+
| **Name**              | **Pri   | **Stack  | **Pr     | **OsTaskA  |
|                       | ority** | Size[4   | eemptive | utostart** |
|                       |         | Bytes]** | Poilcy** |            |
|                       |         |          |          |            |
|                       |         | **Stack  | **Pr     |            |
|                       |         | Size     | eemptive |            |
...
|                       |         | Bytes]** |          |            |
+=======================+=========+==========+==========+============+
| iSoft                 | 25      | 1024     | FULL     | False      |
| _Auto_OsTask_10ms_BSW |         |          |          |            |
+-----------------------+---------+----------+----------+------------+
| iSof                  | 25      | 1024     | FULL     | False      |
| t_Auto_OsTask_5ms_BSW |         |          |          |            |
+-----------------------+---------+----------+----------+------------+
| iSof                  | 25      | 256      | FULL     | False      |
| t_Auto_OsTask_1ms_BSW |         |          |          |            |
+-----------------------+---------+----------+----------+------------+
| iSo                   | 63      | 256      | FULL     | False      |
| ft_Auto_OsTask_SchM_0 |         |          |          |            |
+-----------------------+---------+----------+----------+------------+
| iSoft_Aut             | 63      | 1024     | NON      | True       |
| o_DEFAULT_OsTask_Init |         |          |          |            |
+-----------------------+---------+----------+----------+------------+
...
+----------------+------------+-------------+------------+------------+
| CAN            | GATEGORY_2 | 512         | 1          | False      |
| 0_ORed_0_15_MB |            |             |            |            |
+----------------+------------+-------------+------------+------------+
| CAN0           | GATEGORY_2 | 512         | 1          | False      |
| _ORed_16_31_MB |            |             |            |            |
+----------------+------------+-------------+------------+------------+
...
+-----------------------+----------------------+----------------------+
| **Name**              | **Set Event**        | **Set Event Task**   |
+=======================+======================+======================+
| iSoft                 | iSoft                | iSoft                |
| _Auto_OsAlarm_1ms_BSW | _Auto_OsTask_1ms_BSW | _Auto_OsTask_1ms_BSW |
+-----------------------+----------------------+----------------------+
| iSoft                 | iSoft                | iSoft                |
| _Auto_OsAlarm_5ms_BSW | _Auto_OsTask_5ms_BSW | _Auto_OsTask_5ms_BSW |
+-----------------------+----------------------+----------------------+
| iSoft                 | iSoft                | iSoft                |
| _Auto_OsAlarm_10ms_BSW| _Auto_OsTask_10ms_BSW| _Auto_OsTask_10ms_BSW|
+-----------------------+----------------------+----------------------+
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image15.png
   :width: 5.27017in
   :height: 3.02046in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image16.png
   :width: 5.69082in
   :height: 2.86642in
...
Demo_S32K148_V2510_S32DS_V3p5_Project\\BSW\\Config\\BSW_Config\\RTE路径下的Rte.c文件中，用户可以自行在相关的任务中添加自己需要实现的功能。

The OS tasks executed in the project is located in Rte.c file under the
path of
Demo_S32K148_V2510_S32DS_V3p5_Project\\BSW\\Config\\BSW_Config\\RTE.
Users can add the functions they need to implement in relevant tasks.

.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image17.png
   :width: 6.52509in
   :height: 3.99722in
...
.. image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image18.png
   :width: 6.77153in
   :height: 1.82847in

.. |image1| image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image11.png
   :width: 6.69722in
   :height: 1.58472in
.. |image2| image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image12.png
   :width: 6.77222in
   :height: 3.52917in
.. |image3| image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image11.png
   :width: 6.69722in
   :height: 1.58472in
.. |image4| image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image12.png
   :width: 6.77222in
   :height: 3.52917in
.. |image5| image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image13.png
   :width: 7.25833in
   :height: 1.36111in
.. |image6| image:: /_static/工程说明(Demo_Project_Description)/小满S32K148示例工程说明/image13.png
   :width: 7.25833in
   :height: 1.36111in
